...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <nav class="navbar navbar-light bg-light">
            <ul class="navbar-nav">
            <?php if (isset($_SESSION['isRH'])) {
                echo '<li class="nav-item pe-2"><a href="php/createOffer.php"><img id="addOffer" src="assets/plus-circle-fill.svg" alt="" width="30" height="24"></a></li>';
                }?>
            <li class="nav-item">
